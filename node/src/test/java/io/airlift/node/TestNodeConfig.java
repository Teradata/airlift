...
import static io.airlift.node.NodeConfig.AddressType.HOSTNAME;
import static io.airlift.node.NodeConfig.AddressType.IP;
...
public class TestNodeConfig
{
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("node.internal-address-type", "HOSTNAME")
                .build();
