...
import io.airlift.node.NodeConfig.AddressType;
...
public class NodeInfo
{
            ...
            AddressType addressType)
    {
        ...
        checkNotNull(addressType, "addressType is null");
        ...
        if (internalAddress != null) {
            ...
            this.internalAddress = findInternalAddress(addressType);
        }
    ...
    private static String findInternalAddress(AddressType addressType)
    {
        switch (addressType) {
            case IP:
